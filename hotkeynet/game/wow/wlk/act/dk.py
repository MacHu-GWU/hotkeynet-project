...
class Frost(ActFactory):
    ...
    # 其他
    Chains_of_Ice = None  # 寒冰锁链
    Empower_Rune_Weapon = None  # 强化符文武器
    Horn_of_Winter = None  # 寒冬号角, buff 技能

    Icebound_Fortitude = None  # 冰固坚韧, 减伤技能
...
class Unholy(ActFactory):
    ...
    # 其他
    Anti_Magic_Shell = None  # 反魔法护盾
    Army_of_the_Dead = None  # 亡者大军
    Corpse_Explosion = None  # 尸体爆炸
    Death_and_Decay = None  # 死亡凋零
