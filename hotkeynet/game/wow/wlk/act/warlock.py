...
class Affliction(ActFactory):
    ...
    Seed_of_Corruption = None  # 腐蚀之种, AOE 技能
    ...
    # 诅咒
    Curse_of_Doom = None  # 厄运诅咒
    Curse_of_Exhaustion = None  # 疲劳诅咒, 痛苦系天赋技能
    Curse_of_the_Elements = None  # 元素诅咒
    Curse_of_Tongues = None  # 语言诅咒
    Curse_of_Weakness = None  # 虚弱诅咒

    Drain_Life = None  # 吸取生命
    Drain_Mana = None  # 吸取法力
    Drain_Soul = None  # 吸取灵魂碎片

    # 恐惧
    Fear = None  # 恐惧
    Howl_of_Terror = None  # 恐惧咆哮, 群体恐惧

    # 回蓝
    Life_Tap = None  # 生命分流, 生命转法力
...
class Demonology(ActFactory):
    ...
    Demonic_Circle_Summon = None  # 恶魔之环 召唤
    Demonic_Circle_Teleport = None  # 恶魔之环 传送
...
class Destruction(ActFactory):
    ...
    # AOE
    Hellfire = None  # 地狱火, 俗称自燃
    Rain_of_Fire = None  # 火焰之雨
