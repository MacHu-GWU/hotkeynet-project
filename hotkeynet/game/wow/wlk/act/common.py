...
class Movement(ActFactory):
    ...
    MOVE_LEFT = None  # 往左平移
    MOVE_RIGHT = None  # 往右平移
    MOVE_FORWARD = None  # 往前
    MOVE_BACKWARD = None  # 往后
    MOVE_LEFT_TOP = None  # 左上
    MOVE_RIGHT_TOP = None  # 右上
    MOVE_LEFT_BOTTOM = None  # 左下
    MOVE_RIGHT_BOTTOM = None  # 右下
    TURN_LEFT = None  # 向左转
    TURN_RIGHT = None  # 向右转
    JUMP = None  # 跳跃
    TOGGLE_AUTO_RUN = None  # 切换自动奔跑
    FOLLOW_TARGET = None  # 跟随目标
    FOLLOW_FOCUS = None  # 跟随焦点目标
    PITCH_UP = None  # 在水中/空中上浮
    PITCH_DOWN = None  # 在水中/空中下沉
...
class PetAction(ActFactory):
    ...
    ATTACK = None  # 宠物攻击主人的目标
    FOLLOW = None  # 宠物跟随主人
    STAY = None  # 宠物停留
    AGGRESSIVE = None  # 进攻模式
    DEFENSIVE = None  # 防御模式
    PASSIVE = None  # 被动模式
...
class Target(ActFactory):
    ...
    TARGET_NEAREST_ENEMY = None
    TARGET_NEAREST_FRIEND = None
    TARGET_SELF = None
    TARGET_PARTY_MEMBER_1 = None
    TARGET_PARTY_MEMBER_2 = None
    TARGET_PARTY_MEMBER_3 = None
    TARGET_PARTY_MEMBER_4 = None

    INTERACT_WITH_TARGET = None
    INTERACT_WITH_MOUSE_OVER = None
    ASSIST_TARGET = None

    SET_TARGET_AS_FOCUS = None
    TARGET_FOCUS = None
    TARGET_LAST_TARGET = None
    ...
    TARGET_FOCUS_TARGET_TARGET = None
    """
...
class Camera(ActFactory):
    ...
    SET_FIRST_CAMERA_VIEW_1 = None
    # 第二个视角永远是视角拉到最远, 并且开启摄像头永远跟随的模式时系统自动的高度.
    SET_FIRST_CAMERA_VIEW_2 = None
    # 第三个视角备用
    SET_FIRST_CAMERA_VIEW_3 = None

    # 将当前视角设置保存为第 N 套 ...
    SAVE_FIRST_CAMERA_VIEW_1 = None
    SAVE_FIRST_CAMERA_VIEW_2 = None
    SAVE_FIRST_CAMERA_VIEW_3 = None
...
class System(ActFactory):
    ...
    MASTER_VOLUME_DOWN = None  # 音量调大
    MASTER_VOLUME_UP = None  # 音量调小
    TOGGLE_USER_INTERFACE = None  # 开关用户界面
...
class General(ActFactory):
    ...
    ESC = None  # 按 ECS 键
    TRIGGER = None  # Hotkey 里面的 %Trigger% 语法, 把触发器作为动作按下去

    STOP_CASTING_KEY_OEM1_SEMICOLUMN = None  # 取消施法
    STOP_ATTACKING_KEY_OEM7_QUOTE = None  # 取消攻击
    LEAVE_PARTY_MACRO_KEY_ALT_END = None  # 离开队伍宏
    """
    ...
    CONFIRM_MACRO_KEY_NUMPAD_5 = None  # 按下接受按钮宏, 可以用于接收组队, 进入随机地下城
    """
    ...
    SET_FOCUS_KEY_NUMPAD_6 = None  # 设置当前目标为焦点宏
    """
    ...
    CLEAR_FOCUS_NUMPAD_7 = None  # 取消已设置的焦点
    """
    ...
    MOUNT_UP_MACRO_KEY_NUMPAD_11_DIVIDE = None
    """
    ...
    MOUNT_DOWN_MACRO_CTRL_OEM3_WAVE = None
    """
    ...
    LAND_MOUNT_SPELL_KEY_CTRL_Z = None  # 陆地坐骑, 不是宏
    """
    陆地专用坐骑.
    """

    EAT_FOOD_KEY_CTRL_T = None  # 吃喝食物

    BUFF_SELF_MACRO_KEY_8 = None  # 给自己刷 Buff 的宏
    """
    ...
    BUFF_RAID_MACRO_KEY_9 = None  # 给团队刷 Buff
    """
    用于给团队刷 Buff 的宏或技能, 这个因职业而异
    """

    RACIAL_SKILL_KEY_ALT_A = None  # 种族天赋 1
    USE_TRINKET_1_KEY_ALT_S = None  # 使用饰品 1
    USE_TRINKET_2_KEY_ALT_D = None  # 使用饰品 2

    DPS_BURST_MACRO_KEY_ALT_D = None  # DPS 爆发宏
    """
    ...
    SHOOT_WAND_OR_RANGE_WEAPON_KEY_SHIFT_TAB = None  # 使用魔杖宏
    """
    Mage / Warlock / Priest shoot wand, Warrior / Rogue shoot range weapon
    """

    TOGGLE_MAIN_GAME_MENU = None  # 开关游戏选项界面, 可以用于一键登出
