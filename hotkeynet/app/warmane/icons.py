...
class Icons:
    ...
    spell_holy_divinehymn = (dir_icons / "spell_holy_divinehymn.jpg").abspath
    spell_holy_excorcism = (dir_icons / "spell_holy_excorcism.jpg").abspath
    spell_holy_powerwordbarrier = (dir_icons / "spell_holy_powerwordbarrier.jpg").abspath
    spell_holy_symbolofhope = (dir_icons / "spell_holy_symbolofhope.jpg").abspath
    ...
    spell_nature_strengthofearthtotem02 = (dir_icons / "spell_nature_strengthofearthtotem02.jpg").abspath
    spell_nature_tranquility = (dir_icons / "spell_nature_tranquility.jpg").abspath
    spell_nature_tremortotem = (dir_icons / "spell_nature_tremortotem.jpg").abspath
