    ...
    def set_mode_solo_raid_10p_batlefury_flydps_core_team(cls, config: Config):
        ...
        config.active_character_config = ActiveCharacterConfig(
            active_characters=[
                ...
                CharacterFactory.make_char_fatmulti9_glowyy_pve_holy_pala().evolve(window_index=9),
                CharacterFactory.make_char_monkey130_flydps_pve_blood_tank_dk().evolve(window_index=10),
            ]
        )
