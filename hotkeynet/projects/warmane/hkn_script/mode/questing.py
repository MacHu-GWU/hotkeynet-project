    ...
    def set_mode_questing_grizzly_hill_daily_gold_farm_team3_litgoat_shaman(cls, config: Config):
        ...
        config.active_character_config = ActiveCharacterConfig(
            active_characters=[
                ...
                CharacterFactory.make_char_makun7551_laoshou_retri_paladin().evolve(leader1_window_index=19),
                CharacterFactory.make_char_fatmulti23_lgsmm_pve_elemental_shaman().evolve(leader1_window_index=19),
                CharacterFactory.make_char_fatmulti24_lgsmn_pve_elemental_shaman().evolve(leader1_window_index=19),
                CharacterFactory.make_char_fatmulti25_lgsmo_pve_elemental_shaman().evolve(leader1_window_index=19),
                CharacterFactory.make_char_fatmulti26_lgsmp_pve_elemental_shaman().evolve(leader1_window_index=19),
            ]
        )
